...
pub struct StdAudioNormalizer {
    fixed_gain: f32,
    current_gain: f32,
}

unsafe impl Send for StdAudioNormalizer {}
unsafe impl Sync for StdAudioNormalizer {}

impl StdAudioNormalizer {
...
impl DspProcessor for StdAudioNormalizer {
    #[inline(always)]
