...
pub struct StdBiquadFilter {
    coeffs: StdBiquadCoeffs,
    s1: [f64; 2],
    s2: [f64; 2],
}

impl StdBiquadFilter {
    fn new() -> Self {
        Self {
            coeffs: StdBiquadCoeffs::new(),
            s1: [0.0; 2],
            s2: [0.0; 2],
        }
    }
...
pub struct StdEqProcessor {
    filters: Vec<StdBiquadFilter>,
    frequencies: [f32; 10],
    gains: [f32; 10],
    target_gains: [f32; 10],
    q_factors: [f32; 10],
...
impl StdEqProcessor {
    pub fn new() -> Self {
        ...
        for _ in 0..10 {
            filters.push(StdBiquadFilter::new());
        }
...
impl DspProcessor for StdEqProcessor {
