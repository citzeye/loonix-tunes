...
Item {
    ...
    readonly property int activeWidth: Math.min(width - 20, maxContentWidth)
    ...
    function refreshUserPresetNames() {
        ...
        eqRoot.userPresets = newNames;
    }

    Component.onCompleted: {
        loadDefaultPresets()
        refreshUserPresetNames()
        // Sync active preset from saved config
    ...
    property int activePresetIndex: -1 // -1 = none, 0-5 = default, 6-11 = user
    ...
    function loadPresetByIndex(index) {
        ...
        var wetVal = 100
        if (index >= 0 && index < 6) {
            gains = eqRoot.defaultPresetValues[index]
        ...
        ColumnLayout {
            ...
            Rectangle {
                ...
                RowLayout {
                    ...
                    anchors.horizontalCenter: parent.horizontalCenter
                    spacing: 8 // Spacing antar seksi (Gain - EQ - Mix)

                    // ==========================================
                    // --- LEFT: GAIN (MACRO FADER) ---
                    // ==========================================
                    ColumnLayout {
                    ...
                    RowLayout {
                        Layout.fillHeight: true
                        spacing: 2 // Jarak rapat antar slider frekuensi
            ...
            GridLayout {
                ...
                Repeater {
                    model: eqRoot.defaultPresets.concat(eqRoot.userPresets)
                    delegate: Button {
                        id: pBtn
                        property bool isActive: eqRoot.activePresetIndex === index
                        Layout.fillWidth: true
                        ...
                        onClicked: {
                            eqRoot.loadPresetByIndex(index)
                        }
                    }
                }
            }
    ...
    Item {
        ...
        Rectangle {
            ...
            MouseArea {
                anchors.fill: parent
                onClicked: saveEqDialog.visible = false
            }
        }
        ...
        Rectangle {
            ...
            ColumnLayout {
                ...
                ComboBox {
                    ...
                    model: [
                        "1: " + eqRoot.userPresets[0],
                        "2: " + eqRoot.userPresets[1],
                        "3: " + eqRoot.userPresets[2],
                        "4: " + eqRoot.userPresets[3],
                        "5: " + eqRoot.userPresets[4],
                        "6: " + eqRoot.userPresets[5]
                    ]
